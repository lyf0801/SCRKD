...
class TransXNet_SCRKD5(nn.Module):
    ...
    def forward(self,  x_lr, x_hr=None, labels_lr=None, labels_hr=None):
        ...
        if self.training:
            ...
            loss_multi_view_similarity = torch.tensor(0)
            """
            ...
            return loss_sod, loss_multi_view_similarity * 0.1, loss_multi_scale_feature_loss*0.5, loss_prediction_distillation * 20 #scale weights
