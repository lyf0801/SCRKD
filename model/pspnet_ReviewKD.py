...
class PSPNet_ReviewKD(nn.Module):
    def __init__(self):
        super(PSPNet_ReviewKD, self).__init__()
    ...
    def forward(self, x_lr, x_hr=None, labels_lr=None):
        ...
        if self.training:
            ...
            student_out1, student_out2, student_out3, student_out4 = self.reviewKD([student_out1, student_out2, student_out3, student_out4])
    ...
    def distillation_loss(self, student_out1, student_out2, student_out3, student_out4, student_out5, teacher_out1, teacher_out2, teacher_out3, teacher_out4, teacher_out5):
        ...
        distillation_loss = hcl([student_out1, student_out2, student_out3, student_out4, student_out5], [teacher_out1, teacher_out2, teacher_out3, teacher_out4, teacher_out5]) 
