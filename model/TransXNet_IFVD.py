...
class TransXNet_IFVD(nn.Module):
    def __init__(self, img_size):
        super(TransXNet_IFVD, self).__init__()
    ...
    def forward(self, x_lr, x_hr=None, labels_lr=None):
        ...
        if self.training:
            ...
            loss_distillation = self.distillation_loss(student_features, teacher_features, student_smap1, teacher_smap1, labels_lr)
    ...
    def distillation_loss(self, student_outs, teacher_outs, student_smap1, teacher_smap1, labels):
        ...
        c = self.criterion_ifv([student_out1, student_out2, student_out3, student_out4], [teacher_out1, teacher_out2, teacher_out3, teacher_out4], labels)
        # print("a")
        # print(a)
        # print("b")
        # print(b)
        ...
        distillation_loss += 0.0001 * b
        distillation_loss += 100 * c
        
        return distillation_loss / 2 #scale factor 
