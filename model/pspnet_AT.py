...
class PSPNet_AT(nn.Module):
    def __init__(self):
        super(PSPNet_AT, self).__init__()
    ...
    def distillation_loss(self, student_out1, student_out2, student_out3, student_out4, student_out5, teacher_out1, teacher_out2, teacher_out3, teacher_out4, teacher_out5):
        ...
        distillation_loss = at_loss(student_out1, teacher_out1) + at_loss(student_out2, teacher_out2) + at_loss(student_out3, teacher_out3) + at_loss(student_out4, teacher_out4) + at_loss(student_out5, teacher_out5)

        return distillation_loss * 100  #balanced weights
