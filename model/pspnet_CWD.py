...
class PSPNet_CWD(nn.Module):
    def __init__(self):
        super(PSPNet_CWD, self).__init__()
    ...
    def distillation_loss(self, student_out1, student_out2, student_out3, student_out4, student_out5, teacher_out1, teacher_out2, teacher_out3, teacher_out4, teacher_out5):
        ...
        distillation_loss = criterion_cwd(student_out1, teacher_out1) + criterion_cwd(student_out2, teacher_out2) + criterion_cwd(student_out3, teacher_out3) + criterion_cwd(student_out4, teacher_out4) + criterion_cwd(student_out5, teacher_out5)
