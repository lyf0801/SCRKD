...
class PSPNet_SKD(nn.Module):
    def __init__(self):
        super(PSPNet_SKD, self).__init__()
        ...
        self.criterion_pair_wise_for_interfeat = CriterionPairWiseforWholeFeatAfterPool(scale=0.5, feat_ind=-5)
    ...
    def forward(self, x_lr, x_hr=None, labels_lr=None):
        ...
        if self.training:
            ...
            loss_distillation = self.distillation_loss([student_out1, student_out2, student_out3, student_out4, student_out5], [teacher_out1, teacher_out2, teacher_out3, teacher_out4, teacher_out5], student_smap1, teacher_smap1)
    ...
    def distillation_loss(self, student_outs, teacher_outs, student_smap1, teacher_smap1):
        ...
        b = self.criterion_pair_wise_for_interfeat([student_out1, student_out2, student_out3, student_out4, student_out5], [teacher_out1, teacher_out2, teacher_out3, teacher_out4, teacher_out5])
        c = self.criterion_adv_for_G(self.D_model(student_smap1)[0])

        distillation_loss += 0.1 * a
        distillation_loss += 1.0 * b
        distillation_loss += 0.001 * c
