...
class TransXNet_SKD(nn.Module):
    def __init__(self, img_size):
        super(TransXNet_SKD, self).__init__()
    ...
    def distillation_loss(self, student_outs, teacher_outs, student_smap1, teacher_smap1):
        ...
        distillation_loss += 0.1 * a  #scale factor for TransXNet
    ...
    def Discriminator_backward(self, student_smap1, teacher_smap1):
        ...
        return d_loss * 0.1 # scale factor for TransXNet
